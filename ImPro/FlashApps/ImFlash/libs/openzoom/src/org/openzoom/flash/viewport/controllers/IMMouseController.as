 ...
 */
public final class IMMouseController extends ViewportControllerBase
                                   implements IViewportController
{
     ...
     *  Constructor.
     */
    public function IMMouseController()
    {
        createClickTimer()
    }
    ...
    {
		trace("view_addedToStageHandler");
