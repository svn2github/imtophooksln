...
//		_transform.setBoundXYWH(x, y, w, h);
...
//        trace("[NormalizedViewport]", "endTransform")
    ...
    public function touchBeginTransform():void
    {
//    	trace("[NormalizedViewport]", "touchBeginTransform")
    	dispatchEvent(new ViewportEvent(ViewportEvent.TRANSFORM_TOUCH_START))
    }
    public function touchEndTransform():void
    {
//    	trace("[NormalizedViewport]", "touchEndTransform")
    	dispatchEvent(new ViewportEvent(ViewportEvent.TRANSFORM_TOUCH_END))
