...
//			addEventListener(TouchEvent.MOUSE_UP, touchDropIt);								
		...
		public function dispose():void{
			...
			removeEventListener(MouseEvent.MOUSE_MOVE, pickMove);
			removeEventListener(MouseEvent.MOUSE_UP, dropIt);

			handle.removeEventListener(MouseEvent.MOUSE_DOWN, pickUp);
			handle.removeEventListener(MouseEvent.MOUSE_MOVE, pickMove);
			handle.removeEventListener(MouseEvent.MOUSE_UP, dropIt);				
			handle = null;
