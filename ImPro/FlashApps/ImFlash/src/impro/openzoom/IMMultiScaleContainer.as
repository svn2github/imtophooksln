 ...
 */
public final class IMMultiScaleContainer extends Sprite
...
//    public static const DEFAULT_SCENE_HEIGHT:Number = 18000 * 5.2;
     ...
     * Constructor.
     */
    public function IMMultiScaleContainer(viewportListenToEvent:Boolean = true)
    {
    	// for imPro
    ...
    private var isLResView:Boolean;
   ...
   ;[ArrayElementType("org.openzoom.flash.viewport.IViewportController")]
    ...
    private function createMouseCatcher():void
    {
        ...
        g.drawRect(0, 0, DEFAULT_VIEWPORT_WIDTH, DEFAULT_VIEWPORT_HEIGHT)
        g.endFill()
    ...
    private function createViewport(scene:IReadonlyMultiScaleScene):void
    {
        _viewport = new NormalizedViewport(DEFAULT_VIEWPORT_WIDTH,
	        ...
	        _viewport.addEventListener(ViewportEvent.TRANSFORM_TOUCH_START,
	                                   viewport_transformTouchStartHandler,
	                                   false, 0, true)
	        _viewport.addEventListener(ViewportEvent.TRANSFORM_TOUCH_END,
	                                   viewport_transformTouchEndHandler,
	                                   false, 0, true)
    ...
    private function viewport_transformTouchStartHandler(event:ViewportEvent):void{
//        trace("Container: ViewportEvent.TRANSFORM_TOUCH_START")    	
    }
    private function viewport_transformTouchEndHandler(event:ViewportEvent):void{
//        trace("Container: ViewportEvent.TRANSFORM_TOUCH_END")
...
//	public function setViewportXYWH(x:Number, y:Number, w:Number, h:Number):void{
//		viewport.setViewportXYWH(x, y, w, h);
//	}
	...
	public function viewportRect(x:Number, y:Number, width:Number, height:Number):void{
    ...
    public function dispose():void
    {
    	...
    	while (super.numChildren > 0){
    		if(super.getChildAt(0) is ImagePyramidRenderer)
    			(super.getChildAt(0) as ImagePyramidRenderer).dispose();
