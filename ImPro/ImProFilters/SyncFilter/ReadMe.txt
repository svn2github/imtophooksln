========================================================================
    MFC 程式庫：SyncFilter 專案概觀
========================================================================


AppWizard 已經為您建立了這個 SyncFilter DLL。這個 DLL 不僅
示範了使用 MFC 的基本概念，
也是您撰寫 DLL 的起點。

這個檔案包含一份摘要，
簡要說明構成您的 SyncFilter DLL 的所有檔案，它們個別的內容。
...
SyncFilter.cpp
    這是主要 DLL 原始程式檔。它含有 CSyncFilterApp 類別。
...
StdAfx.h, StdAfx.cpp
    這些檔案是用來建置名為 SyncFilter.pch 的先行編譯標頭 (PCH) 檔，
