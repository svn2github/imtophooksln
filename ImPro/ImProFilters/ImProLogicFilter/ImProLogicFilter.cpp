...
HRESULT ImProLogicFilter::CreatePins()
{
	...
	{
		GSOUTPIN_ACCEPT_MEDIATYPE(GSMEDIATYPE_FILTER_CONFIG, GSMEDIASUBTYPE_GSARTagLayoutStrategy_CONFIG, FALSE, GSREF_ACCEPT_MEDIATYPE, sizeof(GSARLayoutStartegyData), 0, 0)
	};
