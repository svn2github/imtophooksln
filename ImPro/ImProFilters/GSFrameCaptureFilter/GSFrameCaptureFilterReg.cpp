#include "stdafx.h"
#include "GSFrameCaptureFilterReg.h"
#include "GShowGUID.h"
...
WCHAR g_FilterName[] = L"GS Frame Capture Filter";
GUID g_FILTER_CLSID = CLSID_GSFrameCaptureFilter;
LPFNNewCOMObject g_pNewFilterFunc = GSFrameCaptureFilter::CreateInstance;

WCHAR g_PropPageName[] = L"GS Frame Capture Filter PropPage";
GUID g_PROP_CLSID = CLSID_GSFrameCaptureFilterProp;
LPFNNewCOMObject g_pNewPropFunc = GSFrameCaptureFilterProp::CreateInstance;
