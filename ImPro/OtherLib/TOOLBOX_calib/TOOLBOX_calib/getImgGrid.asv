 disp('Enter the image name for extrinsic paramerter:');
 dir ;
...
%%  step 2  read the image to calibrate the extrinsic para
...
%%  click_img_calib 
% get the x in cam space ahd the X in plane  space
