...
class DXRendererInputPin;
class DXRendererInputPin : public CBaseInputPin, public D3DBaseInputPin
{
protected:
	DXBaseRenderer *m_pRenderer;

public:
	DECLARE_IUNKNOWN;
	STDMETHODIMP NonDelegatingQueryInterface(REFIID iid, void **ppv);

	DXRendererInputPin(__inout DXBaseRenderer *pRenderer,
		__inout HRESULT *phr,
	...
	//from D3DBaseInputPin
	virtual HRESULT GetD3DFilter(IDXBaseFilter*& pFilter);
};

class DXBaseRenderer : public CBaseFilter, public D3DBaseFilter
{
protected:

	friend class DXRendererInputPin;
	...
	DXRendererInputPin *m_pInputPin;     // Our renderer input pin object
...
public:
	...
	DXBaseRenderer(REFCLSID RenderClass, // CLSID for this renderer
