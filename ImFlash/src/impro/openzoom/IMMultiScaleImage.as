 ...
 */
public final class IMMultiScaleImage extends IMMultiScaleImageBase
{
//	include "../core/Version.as"
     ...
     * Constructor.
     */
    public function IMMultiScaleImage()
    {
        super()
    ...
    private function addImage(descriptor:IImagePyramidDescriptor):void
    {
    	...
    	// probably use multiple descriptors here
...
//        container.viewportWidth = 800 / 2;
//        container.viewportHeight = 600 / 2;
...
//        image2 = createImage(descriptor,
//                            sceneWidth/2,
//                            sceneHeight/2);
                            
        // create renderer (another for high-resolution)
