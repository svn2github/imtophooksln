...
GSPIN_ACCEPT_MEDIATYPE::GSPIN_ACCEPT_MEDIATYPE(GUID mainType, GUID subType)
{
	pMainType = new GUID();
	pSubType = new GUID();
	pFormatType = NULL;
...
GSPIN_ACCEPT_MEDIATYPE::GSPIN_ACCEPT_MEDIATYPE(GUID mainType, GUID subType, GUID formatType)
{
	pMainType = new GUID();
	pSubType = new GUID();
...
GSFILTER_STREAMPIN_DESC::GSFILTER_STREAMPIN_DESC() : GSFILTER_PIN_DESC(), bufW(0), bufH(0)
{

}
GSFILTER_STREAMPIN_DESC::GSFILTER_STREAMPIN_DESC(LPCWSTR _pinName, UINT _bufW, UINT _bufH, GSPIN_TYPE _pinType, GSPIN_ACCEPT_MEDIATYPE_GROUP _acceptTypes, GSFILTER_STREAMPIN_FUNCS _pFunc) 
: GSFILTER_PIN_DESC(_pinName, _pinType, _acceptTypes), bufW(_bufW), bufH(_bufH), pFunc(_pFunc)
{
