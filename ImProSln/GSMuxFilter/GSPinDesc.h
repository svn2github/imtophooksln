...
struct GSFILTER_OUTPUTPIN_DESC : public GSFILTER_PIN_DESC
{
	...
	GSFILTER_OUTPUTPIN_DESC(LPCWSTR _pinName, UINT nMatchIdx, GSPIN_TYPE _pinType, GSOUTPIN_ACCEPT_MEDIATYPE_GROUP _acceptTypes, GSFILTER_OUTPUTPIN_FUNCS _pFunc);
...
struct GSFILTER_STREAMPIN_DESC : public GSFILTER_PIN_DESC
{
	...
	GSFILTER_STREAMPIN_DESC(LPCWSTR _pinName,  UINT nMatchIdx, GSPIN_TYPE _pinType, GSOUTPIN_ACCEPT_MEDIATYPE_GROUP _acceptTypes, GSFILTER_STREAMPIN_FUNCS _pFunc);
