...
struct GSFILTER_INPUTPIN_FUNCS
{
	...
	typedef HRESULT (__stdcall *TransformFuncPtr)(void* self, IMediaSample *pInSample, CMediaType* pInMT, IMediaSample *pOutSample, CMediaType* pOutMT);
...
struct GSFILTER_PIN_DESC
{
	...
	GSFILTER_PIN_DESC();
	GSFILTER_PIN_DESC(LPCWSTR _pinName, GSPIN_TYPE _pinType);
...
struct GSFILTER_INPUTPIN_DESC : public GSFILTER_PIN_DESC
{
	...
	GSFILTER_INPUTPIN_DESC(LPCWSTR _pinName, UINT nMatchIdx, GSPIN_TYPE _pinType, const GSPIN_ACCEPT_MEDIATYPE_GROUP& _acceptTypes, const GSFILTER_INPUTPIN_FUNCS& _pFunc);
...
struct GSFILTER_OUTPUTPIN_DESC : public GSFILTER_PIN_DESC
{
	...
	GSFILTER_OUTPUTPIN_DESC(LPCWSTR _pinName, UINT nMatchIdx, GSPIN_TYPE _pinType, const GSOUTPIN_ACCEPT_MEDIATYPE_GROUP& _acceptTypes, const GSFILTER_OUTPUTPIN_FUNCS& _pFunc);
...
struct GSFILTER_STREAMPIN_DESC : public GSFILTER_PIN_DESC
{
	...
	GSFILTER_STREAMPIN_DESC(LPCWSTR _pinName,  UINT nMatchIdx, GSPIN_TYPE _pinType, const GSOUTPIN_ACCEPT_MEDIATYPE_GROUP& _acceptTypes, const GSFILTER_STREAMPIN_FUNCS& _pFunc);
