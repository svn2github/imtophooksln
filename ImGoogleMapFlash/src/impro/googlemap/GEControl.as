...
//		private var roll:Number = 0;		
		...
		public function GEControl(id:String, parentMap:Map,  $DEBUG:Boolean = true)
		{
			super();
			DEBUG = $DEBUG;
			this.id = id;
...
//			this.addEventListener(MouseEvent.MOUSE_WHEEL, onWheel);
		...
		private static function setupSocket():void{
...
//			socket.addEventListener(ProgressEvent.SOCKET_DATA, onRecvOmViewerSocket);			
		...
		private static function onData(e:DataEvent):void{
...
//				DEBUG_TEXT.text = "+";
		...
		private static function onDisconnect(e:Event):void{
//			if(DEBUG)
